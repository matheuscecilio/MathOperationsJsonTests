...
namespace MathOperations.Tests.SecondDeegreEquations
{
    ...
    {
        [Theory]
        [InlineData("/SecondDeegreEquations/Data/Bhaskara/bhaskara-001.json")]
        [InlineData("/SecondDeegreEquations/Data/Bhaskara/bhaskara-002.json")]
        [InlineData("/SecondDeegreEquations/Data/Bhaskara/bhaskara-003.json")]
